...
enum Errors {
  ...
  GQL_ERROR_SET_IMAGE_META = 'Error: Couldn\'t set file meta for filename: ',
  GQL_ERROR_GET_ALL_IMAGE_META = 'Error: Couldn\'t retrieve all file meta',
  GQL_ERROR_GET_SINGLE_IMAGE_META = 'Error: Couldn\'t retrieve single file meta for id: ',
  GQL_ERROR_DELETE_IMAGE_META = 'Error: Couldn\'t delete feilMeta with id',
